const en: Record<string, string> = {
  ...
  'dashboard.filter.dimHint': 'Affects the token attribution chart only',
  ...
  'dashboard.dim.tenant': 'By tenant',
  ...
  'dashboard.token.attributionDesc.tenant': 'Attributed to tenant entryEnvironment mode from the tenant_env configuration.',

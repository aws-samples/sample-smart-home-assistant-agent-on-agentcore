const en: Record<string, string> = {
  ...
  'overview.usersTitle': 'Users',
  'overview.usersDesc': 'All users in the Cognito user pool. Create a new user (Cognito emails an invitation with a temporary password) or promote an existing user to admin.',
  ...
  'overview.loadingUsers': 'Loading users...',
